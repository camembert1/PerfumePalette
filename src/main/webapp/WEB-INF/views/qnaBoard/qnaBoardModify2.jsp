									...
									<div id="footer">
										<div id="left">
											<c:if test="${qnaboard.qnaPassword eq null}">
												<div>
													<label for="publicPost">공개글</label> <input type="radio"
														name="postType" id="publicPost" value="공개글" checked> <label
														for="privatePost">비밀글</label> <input type="radio"
														name="postType" id="privatePost" value="비밀글">
												</div>
												<div id="hiddendiv" style="display: none">
													<label for="passwordInput" class="password-label">비밀번호 : </label>
													<input class="radius" type="password" name="qnaPassword"
														id="passwordInput" placeholder="숫자만 입력가능합니다." oninput="chkPw()">
												</div>
											</c:if>
											<c:if test="${qnaboard.qnaPassword ne null}">
												<div>
													<label for="publicPost">공개글</label> <input type="radio"
														name="postType" id="publicPost" value="공개글"> <label
														for="privatePost">비밀글</label> <input type="radio"
														name="postType" id="privatePost" value="비밀글" checked>
												</div>
												<div id="hiddendiv" style="display: block">
													<label for="passwordInput" class="password-label">비밀번호 : </label>
													<input class="radius" type="password" name="qnaPassword"
														id="passwordInput" placeholder="숫자만 입력가능합니다." oninput="chkPw()" value="${qnaboard.qnaPassword }">
												</div>
											</c:if>
