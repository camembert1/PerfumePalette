							...
							<div id="nav-right">
										...
										<div id="alert-hover-area">
											...
											<div id="alert">
												<div onclick="location.href='/member/myPage'">
													${member.memberNickname}님마이페이지</div>
											</div>
								...
								<div>
									<img src="../../resources/img/common/wish.png" alt=""
										onclick="location.href = '/wish/list'">
										...
										<div id="helloMsg">
											...
											<div class="chatting-area">
															...
															<%-- 2) 남(이름)이 보낸 메세지 --%>
																<c:if test="${msg.memberId != member.memberId }">
																	<li><b>${msg.memberNickname}</b><br>
																		<p class="chat">${msg.chatContent}</p><span
																			class="chatDate">${chatDate}</span>
																	</li>
																</c:if>
													</c:forEach>
												...
												<div class="input-area">
													...
													<button id="send"><img src="../../../resources/img/chat/arrow.png"
															alt="arrow"></button>
												</div>
											</div>
										</div>
