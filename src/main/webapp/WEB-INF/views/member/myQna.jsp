								...
								<table>
									...
									<tbody>
										<c:forEach items="${myQna }" var="qna" varStatus="i">
											<tr>
												...
												<c:if test="${qna.perfumeNo ne 0 }">
													<td><a href="/qnaboard/qnaDetail/${qna.qnaNo}">
															<c:if test="${qna.perfumeNo ne 0}">* </c:if>
															${qna.qnaSubject}
														</a></td>
												</c:if>
												<c:if test="${qna.perfumeNo eq 0 }">
													<td><a href="/qnaboard/detail?qnaNo=${qna.qnaNo}">
															<c:if test="${qna.perfumeNo ne 0}">* </c:if>
															${qna.qnaSubject}
														</a></td>
												</c:if>
									...
									<tfoot>
										<tr style="border: none;">
											<td><button type="button" id="del" style="margin-top: 30px;">선택삭제</button>
											</td>
										</tr>
									</tfoot>
								</table>
