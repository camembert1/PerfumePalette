...
public class Wish {
	...
	public Wish(int wishNo, Timestamp wishDate, String memberId, int perfumeNo, String perfumeName, String perfumeBrand,
			int perfumeVolume, int perfumePrice, int perfumeQuantity, String pScentCategory, String pImageCategory,
			String pFilename, String pFilerename, String pFilepath, Timestamp perfumeDate, int perfumeStatus) {
		super();
		this.wishNo = wishNo;
	...
	public String toString() {
		return "Wish [wishNo=" + wishNo + ", wishDate=" + wishDate + ", memberId=" + memberId + ", perfumeNo="
				+ perfumeNo + ", perfumeName=" + perfumeName + ", perfumeBrand=" + perfumeBrand + ", perfumeVolume="
				+ perfumeVolume + ", perfumePrice=" + perfumePrice + ", perfumeQuantity=" + perfumeQuantity
				+ ", pScentCategory=" + pScentCategory + ", pImageCategory=" + pImageCategory + ", pFilename="
				+ pFilename + ", pFilerename=" + pFilerename + ", pFilepath=" + pFilepath + ", perfumeDate="
				+ perfumeDate + ", perfumeStatus=" + perfumeStatus + "]";
	}
